...
{
  std::cout << "sally test lastTotalRx=" << (int) lastTotalRx << ", averageThroughput=" << averageThroughput << std::endl;
...
void
simulateProcess (string phyMode)
{
...
{
  string phyMCSMode = "DMG_MCS24";                 /* Type of the Physical Layer. */
  double simulationTime = 5.2;                   /* Simulation time in seconds. */

  Simulator::Schedule (Seconds (0), &simulateProcess, phyMCSMode);
